...
BLIND_PROMPT = (
    "Edit this video to fix the physically unrealistic behavior in the scene. "
    "Make the motion, object interactions, and contact/fluid dynamics look natural and physically plausible. "
    "Preserve the same camera, scene, person, objects, lighting, timing, and all unrelated content as much as possible."
)

TASKS = [
    (
        "Wan2.7 blind",
        "dashscope_wan27_physion_20260924/demo3_wan27_blindprompt_20260924",
        {
            "model": "wan2.7-videoedit",
            "input": {"prompt": BLIND_PROMPT, "media": [{"type": "video", "url": None}]},
            "parameters": {"resolution": "720P", "prompt_extend": True, "watermark": True},
        },
    ),
    (
        "Wan3.0 blind",
        "dashscope_wan27_physion_20260924/wan30_video_prime_demo3_reference_video_blindprompt_20260924",
        {
            "model": "wan3.0-video-prime",
            "input": {"prompt": BLIND_PROMPT, "media": [{"type": "reference_video", "url": None}]},
            "parameters": {"resolution": "480P", "ratio": "adaptive", "duration": 5},
        },
    ),
    (
        "MiniMax-H3 blind",
        "dashscope_wan27_physion_20260924/MiniMax_H3_demo3_reference_video_blindprompt_20260924",
        {
